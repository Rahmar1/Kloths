...
{/*1*/}
        <div className='flex justify-between h-170  mt-10 max-lg:block mb-25 '>
            <div className='w-1/2  max-lg:w-auto justify-self-center'>
                <img src='https://cdn.prod.website-files.com/66bf11df879adcab99a88dbf/672ca88eaaef78fe2b1fe70e_single-col-img.avif'  className='w-auto h-170  ' ></img>
            </div>
            <div className=' align-middle w-1/2 text-left max-md:text-center p-10 mt-30 max-md:my-10 ml-7 max-lg:w-auto'>
       ...
       {/*2*/} 
       <div className='flex justify-between h-170 w-100% mt-10  bg-gray-100 max-lg:block max-lg:mt-130 max-md:mb-170  '>
           
            <div className=' align-middle w-1/2 text-center p-10 mt-30 ml-7 max-lg:w-auto'>
               ...
               <div className='flex justify-center  text-center  gap-8 my-7'>
             ...
             <div className='w-1/2 max-lg:w-auto justify-self-center'>
                <img src='https://cdn.prod.website-files.com/66bf11df879adcab99a88dbf/672de6ca56f53a4160c77ca5_cta-img.avif' className='w-auto h-170' ></img>
            </div>
        </div>
        <Clint/>
        <Footer/>
